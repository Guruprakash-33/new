...
function Contact() {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "0dbfdc45-74f1-40bf-932e-884bb6e0c310");
        ...
        <div className='flex flex-col md:flex-row items-center md:space-x-12'>
          <div className='flex-1'>
            ...
            <div className='mb-4 mt-8'>
              ...
              <a href="mailto:gurupraksh33@gmail.com" className='hover:underline'> gurupraksh33@gmail.com</a>
            </div>
            <div className='mb-4'>
              <p className="inline-block text-green-400 mr-2"></p>
              <span>+91 8248918838</span>
            </div>
            <div className='mb-4'>
                <p className='inline-block text-green-400 mr-2'></p>
                <span>Karapakam,Chennai,India.</span>
            </div>
          <div className='flex-1 w-full'>
              <form className='space-y-4' onSubmit={onSubmit} >
                ...
                <button type='submit' className='bg-gradient-to-r from-green-400 to-blue-500 text-white hidden md:inline transform transition-transform duration-300 hover:scale-105 px-8 py-2 rounded-full'>Send</button>
              </form>
          </div>
        </div>
      </div>
